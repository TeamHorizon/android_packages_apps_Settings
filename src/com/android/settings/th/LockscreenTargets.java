...
public class LockscreenTargets extends Fragment implements ShortcutPickHelper.OnPickListener,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mWaveView = ((MultiWaveView) mActivity.findViewById(R.id.lock_target));
    ...
    private void initializeView(String input) {
        ...
        for (int cc = 0; cc < 8 - mTargetOffset - 1; cc++) {
            String uri = MultiWaveView.EMPTY_TARGET;
            Drawable front = null;
                ...
                if (!uri.equals(MultiWaveView.EMPTY_TARGET)) {
                    try {
                        ...
                        if (in.hasExtra(MultiWaveView.ICON_FILE)) {
                            String rSource = in.getStringExtra(MultiWaveView.ICON_FILE);
        ...
        for (int i = mTargetOffset + 1; i <= mTargetOffset + maxTargets; i++) {
            ...
            if (!uri.equals(MultiWaveView.EMPTY_TARGET) && type != null) {
                try {
                    ...
                    if (pkgName != null) {
                        in.putExtra(MultiWaveView.ICON_PACKAGE, mTargetStore.get(i).pkgName);
                    } else {
                        in.removeExtra(MultiWaveView.ICON_PACKAGE);
                    }
                    uri = in.toUri(0);
    ...
    /**
     * Updates a target in the MultiWaveView
     */
    private void setTarget(int position, String uri, Drawable draw, String iconType, String iconSource, String pkgName) {
        ...
        boolean isSystem = iconType != null && iconType.equals(MultiWaveView.ICON_RESOURCE);
        if (!isSystem) {
            final Drawable activeBack = mResources.getDrawable(com.android.internal.R.drawable.ic_lockscreen_target_activated);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (shortcut_name != null && shortcut_name.equals(EMPTY_LABEL)) {
            ...
            mDialogLabel.setTag(MultiWaveView.EMPTY_TARGET);
    ...
    public void onTrigger(View v, final int target) {
        ...
        if ((target != 0 && (mIsScreenLarge || !mIsLandscape)) || (target != 2 && !mIsScreenLarge && mIsLandscape)) {
            ...
            if (mTargetStore.get(target).uri.equals(MultiWaveView.EMPTY_TARGET)) {
                mDialogLabel.setText(EMPTY_LABEL);
            } else {
            ...
            builder.setPositiveButton(R.string.ok,  new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (type != null && type.equals(MultiWaveView.ICON_RESOURCE)) {
                        targetInset = 0;
                    }
    ...
    public void iconPicked(int requestCode, int resultCode, Intent in) {
        ...
        if (requestCode == IconPicker.REQUEST_PICK_GALLERY) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                mImage.setReadOnly();
                iconType = MultiWaveView.ICON_FILE;
            ...
            iconType = MultiWaveView.ICON_RESOURCE;
